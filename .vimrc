...
""" creating custom file heare using autocmd
au bufnewfile *.sh 0r ~/.vim/header/header-bash.temp
...
""" changing fly mode in auto-pair plugin
...
nnoremap <silent> <C-S-g> :GFiles<CR>
nnoremap <silent> <S-C-b> :Buffer<CR>
nnoremap <C-S-f> :Rg 
